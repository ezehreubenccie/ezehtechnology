...
class CiscoFMC:
    ...
    def build_from_env_vars():
        ...
        host = os.environ.get("FMC_HOST", "wa-fmc2500")
    ...
    def add_group_file(self, filename):
        ...
        """
        print("In add_group_file function")
    ...
    def purge_group_id(self, group_id, group_type):
        ...
        or collected.
        """
        print("In purge_group_id function\n")
