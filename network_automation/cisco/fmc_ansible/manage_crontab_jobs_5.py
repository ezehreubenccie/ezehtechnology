...
# Calculate sleep time until a specific task
def calculate_sleep_time(target_time):
...
if job2_command:
    ...
    if second_job_time:
        ...
        print("Executing the second job...")
        if run_job(job2_command):
            # Comment out the second job after execution
