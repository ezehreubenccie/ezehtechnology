...
#    wasTitle = word.istitle()
    ...
    if wasUpper:
        print('This word was uppercase: ' + word )
        word = word.upper()
    if wasTitle:
        print('This word was title case: ' + word)
        word = word.title()
    print('prefixNonLetters before append to pig Latin list is: ' + prefixNonLetters)
    print('word before append to pigLatin list is: ' + word)
    pigLatin.append(word + prefixNonLetters)
print('pigLatin list is: ', pigLatin)
print('Message is: ' + ' '.join(pigLatin))
